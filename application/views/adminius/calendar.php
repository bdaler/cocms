        ...
        <script src="<?php  echo base_url('assets/adminius/vendors/jquery-ui-1.10.3.js');?>"></script>
        <script src="<?php  echo base_url('assets/adminius/bootstrap/js/bootstrap.min.js');?>"></script>
        <script src="<?php  echo base_url('assets/adminius/vendors/fullcalendar/fullcalendar.js');?>"></script>
        <script src="<?php  echo base_url('assets/adminius/vendors/fullcalendar/gcal.js');?>"></script>
