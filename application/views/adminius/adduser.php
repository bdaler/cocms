<div class="col-md-10">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <?php  echo form_open('adminius/main/adduser',array("class"=>"from-horizontal" ));?>
            ...
            <form class="from-horizontal"  role="form">
                <div class="col-md-4">
                    <fieldset class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" id="foremail" placeholder="Your email">
                    </fieldset>
                    <fieldset class="form-group">
                        <label for="forlogin">Login</label>
                        <input type="text" name="login" class="form-control" id="forlogin" placeholder="Your login">
                    </fieldset>
                    <fieldset class="form-group">
                    ...
                    <button name="save" class="btn btn-primary" type="submit">Add User</button>
                </div>
             </form>
        </div>
    </div>
